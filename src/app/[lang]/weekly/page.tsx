    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto px-4 py-8">
        <div className="max-w-4xl mx-auto">
          <h1 className="text-3xl font-bold mb-2">AI 周报</h1>
          <p className="text-muted-foreground mb-8">每周精选 · 趋势洞察 · 行动建议</p>
          {issues.length === 0 ? (
            <p className="text-muted-foreground text-center py-12">暂无周报，敬请期待。</p>
          ) : (
